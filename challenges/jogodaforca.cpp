...
int main()
{
	...
	std::cout << "REGRAS E AVISOS: " << std::endl << "* Você tem cinco chances de errar;" << std::endl << "* Caracteres especiais nao sao levados em consideracao (cedilha, acento agudo, etc)";
